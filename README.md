...
| **[GGEN](https://github.com/soobujmiah/ggen)** | Android-first creative & document studio (Flutter/Dart) | Pure-Dart core with 143 unit tests, a Flutter shell with 237 widget/controller tests, deterministic text-layout engine with a proven conservation invariant, transactional file persistence with SHA-256 receipts, and a multi-stage PR history validated on a physical device round after round |
